...
- RwLock<> digunakan karena memungkinkan banyak thread untuk membaca vector yang sama secara beresamaan namun membatasi hanya 1 thread yang bisa menulis pada satu waktu pada vector tersebut. Mutex tidak digunakan karena  akan membatasi 1 thread untuk mengakses vector yang sama dalam 1 waktu. Sehingga untuk hal ini lebih cocok menggunakan RwLock<> karena akan ada banyak thread yang membaca vector tersebut dalam waktu bersamaan
